...
Version  : 1.9.1
Release  : 4
URL      : https://files.pythonhosted.org/packages/9e/d9/e2920b9936c239b7c75a41ec03f46342fa787b669be1d1a4885ed9d626c3/spyder-kernels-1.9.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/9e/d9/e2920b9936c239b7c75a41ec03f46342fa787b669be1d1a4885ed9d626c3/spyder-kernels-1.9.1.tar.gz
...
%prep
%setup -q -n spyder-kernels-1.9.1
cd %{_builddir}/spyder-kernels-1.9.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589219248
...
cp %{_builddir}/spyder-kernels-1.9.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/spyder-kernels/4d8c327cf6d4ba1ac22d4feb6df04672893016ef
