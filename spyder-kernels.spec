...
Version  : 1.10.2
Release  : 15
URL      : https://files.pythonhosted.org/packages/99/43/8c66f21a58e30191470923b47f1424692289735439d2e62b35067cefbdcc/spyder-kernels-1.10.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/99/43/8c66f21a58e30191470923b47f1424692289735439d2e62b35067cefbdcc/spyder-kernels-1.10.2.tar.gz
...
%prep
%setup -q -n spyder-kernels-1.10.2
cd %{_builddir}/spyder-kernels-1.10.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614017997
...
cp %{_builddir}/spyder-kernels-1.10.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/spyder-kernels/4d8c327cf6d4ba1ac22d4feb6df04672893016ef
