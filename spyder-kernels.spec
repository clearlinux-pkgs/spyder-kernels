...
Version  : 1.9.0
Release  : 2
URL      : https://files.pythonhosted.org/packages/17/55/876ffcd15cead3cde286640c56d8524691779d0a72fd20c05c692d6c9125/spyder-kernels-1.9.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/17/55/876ffcd15cead3cde286640c56d8524691779d0a72fd20c05c692d6c9125/spyder-kernels-1.9.0.tar.gz
...
%prep
%setup -q -n spyder-kernels-1.9.0
cd %{_builddir}/spyder-kernels-1.9.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585253806
...
cp %{_builddir}/spyder-kernels-1.9.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/spyder-kernels/4d8c327cf6d4ba1ac22d4feb6df04672893016ef
