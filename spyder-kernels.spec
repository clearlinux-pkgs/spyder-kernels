...
%prep
%setup -q -n spyder-kernels-1.10.1
cd %{_builddir}/spyder-kernels-1.10.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609282829
...
cp %{_builddir}/spyder-kernels-1.10.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/spyder-kernels/4d8c327cf6d4ba1ac22d4feb6df04672893016ef
