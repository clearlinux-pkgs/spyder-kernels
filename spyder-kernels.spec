...
Version  : 2.0.3
Release  : 22
URL      : https://files.pythonhosted.org/packages/03/8b/66edfb9f4fb14039481ac9cbf9ac4adc8fe3111785f985c7c3175ab84446/spyder-kernels-2.0.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/03/8b/66edfb9f4fb14039481ac9cbf9ac4adc8fe3111785f985c7c3175ab84446/spyder-kernels-2.0.3.tar.gz
...
%prep
%setup -q -n spyder-kernels-2.0.3
cd %{_builddir}/spyder-kernels-2.0.3
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621272750
...
cp %{_builddir}/spyder-kernels-2.0.3/LICENSE.txt %{buildroot}/usr/share/package-licenses/spyder-kernels/4d8c327cf6d4ba1ac22d4feb6df04672893016ef
